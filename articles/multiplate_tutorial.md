...
The `format` parameter can be either set to `xPONENT`, `INTELLIFLEX` or
`NULL`. In case the format is `NULL`, the function will try to infer the
format based on the filename. For more details, we refer the reader to
the documentation of the \[`process_dir`\] function.
...
```
    ...
    #> Merged output saved to: /tmp/Rtmp8jNaiA/multiplate-tutorial/merged_RAU_20251210_094836.csv
    ...
    #> Computing nMFI values for each analyte
    #> Computing nMFI values for each analyte
    #> Merged output saved to: /tmp/Rtmp8jNaiA/multiplate-tutorial/merged_nMFI_20251210_094836.csv
    ...
    #> Extracting the raw MFI to the output dataframe
    #> Extracting the raw MFI to the output dataframe
    #> Merged output saved to: /tmp/Rtmp8jNaiA/multiplate-tutorial/merged_MFI_20251210_094836.csv
...
```
    ...
    #> [1] "merged_MFI_20251210_094836.csv"  "merged_nMFI_20251210_094836.csv"
    #> [3] "merged_RAU_20251210_094836.csv"
