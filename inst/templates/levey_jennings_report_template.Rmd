...
if (length(intersection_analytes) == length(all_analyte_names)) {
  warning("Not all plates contain the same analytes. The report will contain only the analytes that are present in all plates. Number of all analytes: ", length(all_analyte_names), ". Number of common analytes: ", length(intersection_analytes))
}
