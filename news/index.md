...
- changed regex for NEGATIVE CONTROLS to be more rigorous. For more
  details check the
  [reference](https://mini-pw.github.io/SerolyzeR/reference/translate_sample_names_to_sample_types.html#details).
- added checks to plate builder which raise an error when zero bead
  count wells are encountered.
...
- more precise selection of `data_type` in all of the methods, with
  better flow of optional parameters
  ([\#304](https://github.com/mini-pw/SerolyzeR/issues/304))
- improved the readibility of the levey-jennings and stacked standard
  curve plots ([\#293](https://github.com/mini-pw/SerolyzeR/issues/293),
  [\#292](https://github.com/mini-pw/SerolyzeR/issues/292),
  [\#296](https://github.com/mini-pw/SerolyzeR/issues/296),
  [\#297](https://github.com/mini-pw/SerolyzeR/issues/297))
- fixed reading the experiment date
  ([\#290](https://github.com/mini-pw/SerolyzeR/issues/290))
- improved the documentation
  ([\#313](https://github.com/mini-pw/SerolyzeR/issues/313),
  [\#308](https://github.com/mini-pw/SerolyzeR/issues/308),
  [\#307](https://github.com/mini-pw/SerolyzeR/issues/307))
- added selection of sample types in `process_dir` function
- updated some defaults parameters
  ([\#310](https://github.com/mini-pw/SerolyzeR/issues/310),
  [\#291](https://github.com/mini-pw/SerolyzeR/issues/291))
- fixed the bug with duplicate sample names
  ([\#301](https://github.com/mini-pw/SerolyzeR/issues/301))
...
- reading plate made less restrictive - added an option to skip some
  datatypes
- bug fixes
...
- fixed an issue with reading plate files containing empty wells in the
...
- enhanced and unified file saving for generate_plate_report and
  process_plate
...
- added an option to include raw MFI in the output of the
  `process_plate` function
- renamed output of the model to RAU (Relative Antibody Unit), which
  should be more interpretable for human
