...
test_that("Test reading with layout", {
  path <- system.file("extdata", "random_no_standard_curve.csv", package = "SerolyzeR", mustWork = TRUE)
  layout_path <- system.file("extdata", "random_layout_no_standard_curve.xlsx", package = "SerolyzeR", mustWork = TRUE)
...
test_that("Read a INTELLIFLEX mock file", {
  path <- system.file("extdata", "random_intelliflex.csv", package = "SerolyzeR", mustWork = TRUE)
...
test_that("Test xponent file with holes in the layout", {
  path <- system.file("extdata", "CovidOISExPONTENT_CO_with_holes.csv", package = "SerolyzeR", mustWork = TRUE)
  layout_path <- system.file("extdata", "CovidOISExPONTENT_CO_with_holes_layout.xlsx", package = "SerolyzeR", mustWork = TRUE)
